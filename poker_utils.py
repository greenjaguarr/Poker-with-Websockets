...
def score_of_hand(hand):
    ''' 
    Parameters:
        hand (list of Kaart): een list van 7 Kaart objects.
...
def compare(hand1, hand2):
    '''
    Parameters:
    - twee handen, ieder een list met 7 Kaart objecten

    Output:
    Een integer: 
    1 - als de hand1 beter is
    2 - als hand2 beter is
    0 - als de handen gelijk zijn
    '''
    
    
    score_hand1 = score_of_hand(hand1)
    score_hand2 = score_of_hand(hand2)
    ...
    if score_hand1[0] > score_hand2[0]:
        ...
        tie_breaker = 0
        for i in range(len(score_hand1[1])):
            if waarde_naar_getal(score_hand1[1][i]) > waarde_naar_getal(score_hand2[1][i]):
                tie_breaker = 1
                break
            elif waarde_naar_getal(score_hand1[1][i]) < waarde_naar_getal(score_hand2[1][i]):
                tie_breaker = 2
                break
